...
import Link from "next/link"; // Menggunakan Link bawaan Next.js untuk navigasi project
...
export default function SystemOverviewPage() {
  // Simulasi data recent activity agar dinamis
  const activities = [
    {
      user: "Dr. Sari Dewi",
    ...
    },
    {
      ...
      time: "2 hours ago",
      icon: TrendingUp,
      color: "bg-indigo-700/10 text-indigo-700",
    },
  ];
      ...
      <div className="max-w-7xl mx-auto p-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
          ...
          >
            ...
            <p className="text-xs text-muted-foreground mt-2">Last login: 2 mins ago</p>
          </motion.div>
          ...
          >
            ...
            <p className="text-xs text-muted-foreground mt-2">Last validation: 1 hour ago</p>
          </motion.div>
          ...
          >
            ...
            <p className="text-xs text-muted-foreground mt-2">99.9% accuracy rate</p>
          </motion.div>
        </div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <Link href="/user-management">
              ...
              >
                <div className="flex items-start justify-between mb-4">
                  <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-gray-900 to-gray-700 flex items-center justify-center shadow-sm">
                ...
                <h3 className="font-semibold text-foreground mb-2 group-hover:text-gray-900 transition-colors">User Management</h3>
            ...
            <Link href="/data-ingestion">
              ...
              >
                <div className="flex items-start justify-between mb-4">
                  <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-primary to-purple-600 flex items-center justify-center shadow-sm">
                ...
                <h3 className="font-semibold text-foreground mb-2 group-hover:text-primary transition-colors">Data Ingestion</h3>
                <p className="text-sm text-muted-foreground mb-3">
            ...
            <Link href="/intelligence-lab">
              ...
              >
                <div className="flex items-start justify-between mb-4">
                  <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-blue-600 to-primary flex items-center justify-center shadow-sm">
                ...
                <h3 className="font-semibold text-foreground mb-2 group-hover:text-blue-600 transition-colors">Intelligence Lab</h3>
                <p className="text-sm text-muted-foreground mb-3">
            ...
            <Link href="/medical-audit">
              ...
              >
                <div className="flex items-start justify-between mb-4">
                  <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-primary to-indigo-600 flex items-center justify-center shadow-sm">
                ...
                <h3 className="font-semibold text-foreground mb-2 group-hover:text-primary transition-colors">Medical Audit</h3>
                <p className="text-sm text-muted-foreground mb-3">
            ...
            <Link href="/executive-dashboard">
              ...
              >
                <div className="flex items-start justify-between mb-4">
                  <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-indigo-700 to-primary flex items-center justify-center shadow-sm">
                ...
                <h3 className="font-semibold text-foreground mb-2 group-hover:text-indigo-700 transition-colors">Executive Command</h3>
                <p className="text-sm text-muted-foreground mb-3">
            ...
            <Link href="/claim-growth">
              ...
              >
                <div className="flex items-start justify-between mb-4">
                  <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-primary to-purple-500 flex items-center justify-center shadow-sm">
                ...
                <h3 className="font-semibold text-foreground mb-2 group-hover:text-primary transition-colors">Claim Growth</h3>
                <p className="text-sm text-muted-foreground mb-3">
